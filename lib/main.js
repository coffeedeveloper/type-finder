...
const hasChild = (obj, deep) => ((deep ? 'Array' : '') + 'Object').indexOf(getType(obj)) !== -1;
...
const finder = (obj, type, selector, opts) => {
...
export function GetFinderValue (obj, selector) {
...
export function Finder (obj, type, options = {}) {
  ...
  return finder(obj, type, [], opts).map((d) => {
